...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='/home/fangzheng/data/deep_mag_data/'
    )
    parser.add_argument(
        '--out',
        type=str,
        help='Directory for output .tfrecords files',
        default='/home/fangzheng/data/deep_mag_data/out_3channel_all'
    )
    parser.add_argument('--color', action='store_true', help='Whether to store image as color.', default='True')
    ...
    print(os.path.join(data_dir, 'frameA', '*.png'))
    print(len(glob.glob(os.path.join(data_dir, 'frameA', '*.png'))))
    main()